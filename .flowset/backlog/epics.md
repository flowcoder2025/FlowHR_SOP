...
| EP-10 | 5 | 34 |
| EP-11 | 5 | 20 |
| EP-12 | 8 (+ ST-073~077, 079 헤더 컴포넌트·PWA·온보딩 6개) | 38 (+ 20) |
| **합계 (Phase 2)** | **72** | **379 SP** |
| **합계 (보강 후)** | **80** | **415 SP** |

> 환산: 1 SP ≈ 0.5 MD (개발자 1인 작업일) 가정 시 약 **190 MD**. 풀타임 개발자 2명 × 5개월 (45 MD/월/명) 분량.

## MVP 우선순위 그룹

- **P0 (Sprint 1~6)**: EP-01, EP-02, EP-06, EP-07, EP-08, EP-11, EP-12 + EP-03 ST-070(운영사 대시보드) + EP-10 ST-053/054/055(회사설정/결재라인/카카오 알림톡)
- **P1 (Sprint 7~9)**: EP-03 (ST-011~015), EP-04, EP-05, EP-09
- **P2 (Sprint 10+)**: EP-10 나머지 (ST-056/057), ST-061/067 (△ 화면)
