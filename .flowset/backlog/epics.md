...
- **MVP 우선순위**: P0
- **추정**: 31 SP (stories.md L512 SSOT 정합 2026-05-19)
...
- **추정**: 26 SP (stories.md L513 SSOT 정합 2026-05-19 — ST-070 P0 5 SP 포함)
...
- **MVP 우선순위**: P0
- **추정**: 40 SP (stories.md L516 SSOT 정합 2026-05-19 — ST-071 TA-01 P0 5 SP 포함)
...
- **MVP 우선순위**: P0
- **추정**: 35 SP (stories.md L517 SSOT 정합 2026-05-19)
...
- **MVP 우선순위**: P0
- **추정**: 58 SP (stories.md L518 SSOT 정합 2026-05-19 — round 55 → 58)
...
- **수용 기준**:
  ...
  - 활성 세션 강제 종료
- **MVP 우선순위**: P0
- **추정**: 20 SP (stories.md L521 SSOT 정합 2026-05-19)
...
- **추정**: 38 SP (stories.md L522 SSOT 정합 2026-05-19 — ST-072 CM-06 P0 3 SP 포함)
...
| 2026-05-19 | L39/56/109/128/148/204/222 7곳 Epic 단위 추정 SP를 stories.md L505 SSOT로 정합 (EP-02 31 / EP-03 26 / EP-06 40 / EP-07 35 / EP-08 58 / EP-11 20 / EP-12 38) | Phase 6 KI-071 정합화 |
