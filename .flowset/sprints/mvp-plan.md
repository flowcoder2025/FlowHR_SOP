...
|--------|------|--------|--------------|-----|---------|---------|------|
| **S1** | 1~2 | 모노레포 부트스트랩 + 인증 + RLS + audit | ST-001~005 + ST-068/069 + ST-072 + ST-078 | 21+5+5+3+8 = 42 | 30 | Supabase 프로젝트 + Vercel + NHN 신청 시작 | [sprint-001.md](sprint-001.md) |
| **S2** | 3~4 | 테넌트 라이프사이클 + 회사 설정 P0 | ST-006~010 + ST-053/054 | 31+18 = 49 | 35 | NHN 채널 심사 진행 | [sprint-002.md](sprint-002.md) |
| **S3** | 5~6 | 직원/조직 마스터 + 관리자 대시보드 + Excel/PDF/파일 인프라 | ST-024~030 + ST-071 + ST-063/064/065 | 35+5+15 = 55 | 38 | — | [sprint-003.md](sprint-003.md) |
| **S4** | 7~8 | 근태 PWA + 회사 모니터링 + PWA 설치 | ST-031~036 + ST-077 (P1 — PWA 묶음 진입) | 35+5 = 40 | 30 | NHN 진행 상태 체크포인트 (D+42~56, 활성 보장은 S6 D+71 — §5 정밀 계산) | [sprint-004.md](sprint-004.md) |
| **S5** | 9~10 | 휴가 본류 + 결재라인 조건 분기 | ST-037~040, ST-046 | 8+3+8+8+5 = 32 | 22 | — | [sprint-005.md](sprint-005.md) |
