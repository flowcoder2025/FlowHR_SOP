...
|--------|----------|------------|-----------|
| P0 Critical | 0 | 1 | ❌ |
| P1 High | **1** | 3 | ❌ 임계 미달 — 활성: **KI-077** (WI-019 교차테넌트 FK, ST-005 Day8 scheduled, 사용자 defer 결정 2026-05-28). (KI-046/047/048 batch-006-fix3-rev1 resolved + audit hotfix3 정정 2026-05-18) |
| P2 Medium | **2** | 5 | ❌ 임계 미달 — 활성: KI-054 / KI-061 (둘 다 **Phase 7 React 변환 scheduled** — IconButton aria-label / Stepper 컴포넌트화). **WI-KI-batch-008-wf resolved: ~~KI-049~~ (권한매트릭스 15화면) + ~~KI-060~~ (TA-13 font-weight)**. (이전 resolved: ~~KI-050/051/053/058/063/071/076~~) |
| P3 Low | **22** | 10 | ✅ 트리거 도달 — 활성: KI-005/006/007/016/017/020/023/025/035/036/045/055/066/067/072/073 + **Phase 7 scheduled 재분류 6건 (batch-008): KI-038/054(P2)/057/061(P2)/064/065/068/070 svg·aria·모달·stepper·반응형 — React 변환 시 해소**. **WI-KI-batch-008-wf resolved: ~~KI-043~~(CM-21 i18n) + ~~KI-044~~(CM-04 selector) + ~~KI-069~~(권한매트릭스 표 구조 15화면)**. (batch-007 resolved 8건 + 이전 분) |
