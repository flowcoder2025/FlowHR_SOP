...
| P2 Medium | **4** | 5 | ❌ 임계 미달 — 활성: KI-054 / KI-061 (둘 다 **Phase 7 React 변환 scheduled** — IconButton aria-label / Stepper 컴포넌트화) + **KI-079** (WI-020 rememberMe 세션 TTL 미반영, 세션관리 ST-005) + **KI-092** (WI-020-2 ST-078 AC-5 운영사 감사 미구현, OP-09 audit WI). **WI-KI-batch-008-wf resolved: ~~KI-049~~ (권한매트릭스 15화면) + ~~KI-060~~ (TA-13 font-weight)**. (이전 resolved: ~~KI-050/051/053/058/063/071/076~~) |
